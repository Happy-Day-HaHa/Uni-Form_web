...
export default function Landing() {
  ...
  return (
    <main className={`uf26 ${isHolding ? 'is-holding' : ''}`}>
      ...
      <section className="uf26-quotes">
        <div className="uf26-section-label" data-reveal><span>02</span><p>USED BY REAL STUDENTS</p></div>
        <div className="uf26-quotes__grid">
          <article className="uf26-quote" data-reveal><p>“응답 200개를 이틀 만에 통계표로 뽑아서 지도교수님께 바로 보여드렸어요. 심사 일주일 전에 이걸 알았으면 더 좋았을 것 같아요.”</p><div><b>김도윤</b><span>OO대학교 경영학과 4학년</span></div></article>
          <article className="uf26-quote alt" data-reveal><p>“리마인드를 자동으로 돌려주니까 응답률이 15%에서 30%로 올랐어요. 팀원들 카톡 스팸 안 시켜도 돼서 좋았습니다.”</p><div><b>박서연</b><span>OO대학교 창업동아리 대표</span></div></article>
        </div>
      </section>
