...
export default function Landing() {
  ...
  return <main className="uf-landing motion-page" ref={rootRef}>
    ...
    <footer className="uf-footer"><BrandMark /><p>대학생을 위한 설문 제작과 참여 플랫폼</p><nav><a href="#formmate">FormMate</a><Link to="/surveys">설문 찾기</Link><a href="#leaderboard">리더보드</a><Link to="/login">로그인</Link></nav><small>© 2026 UNIFORM</small></footer>
  </main>
}
