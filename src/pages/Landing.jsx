...
export default function Landing() {
  ...
  return <main className="uf-landing motion-page" ref={rootRef}>
    ...
    <section className="uf-final" data-motion-reveal><div><h2>설문에 새로운 경험을<br />더해보세요</h2><p>FormMate로 만들고, 응답이 활동이 되는 UniForm에서 시작하세요.</p><Link className="uf-button uf-button--primary" to="/signup">시작하기</Link></div></section>
