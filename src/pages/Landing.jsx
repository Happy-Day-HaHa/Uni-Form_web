...
export default function Landing() {
  ...
  return <main className="uf-landing motion-page" ref={rootRef}>
    <nav className="uf-nav" aria-label="주요 메뉴"><Link className="uf-nav__brand" to="/"><BrandMark /></Link><div className="uf-nav__links"><a href="#formmate">FormMate</a><a href="#leaderboard">리더보드</a><a href="#team">팀 관리</a></div><div className="uf-nav__actions"><Link className="uf-nav__login" to="/login">로그인</Link><Link className="uf-button uf-button--primary" to="/signup">무료로 시작하기</Link></div></nav>
    <section className="uf-hero" aria-labelledby="hero-title"><div className="uf-hero__copy"><span className="uf-kicker" data-motion-reveal>UNIFORM</span><h1 id="hero-title" data-motion-reveal style={{ '--delay': '60ms' }}>설문에 재미를 더한<br /><em>AI 폼빌더</em></h1><p data-motion-reveal style={{ '--delay': '120ms' }}>FormMate와 대화해 설문을 만들고,<br />리더보드와 경품으로 더 많은 참여를 이끌어보세요.</p><div className="uf-hero__actions" data-motion-reveal style={{ '--delay': '180ms' }}><Link className="uf-button uf-button--primary" to="/formmate">무료로 설문 만들기</Link><Link className="uf-button uf-button--secondary" to="/surveys">설문 둘러보기</Link></div></div><ProductFrame label="UniForm 설문 만들기" className="uf-hero__product" data-motion-reveal style={{ '--delay': '160ms' }}><FormMatePreview compact /></ProductFrame></section>
    <section className="uf-problem"><div data-motion-reveal><span className="uf-kicker">WHY UNIFORM</span><h2>설문은 완성됐는데,<br />참여자는 충분한가요?</h2><p>단톡방을 옮겨 다니고, 커뮤니티에 글을 올리고, 친구에게 다시 부탁했던 경험. 설문보다 응답자를 모으는 일이 더 오래 걸리곤 합니다.</p></div><div className="uf-problem-insights" data-motion-reveal style={{ '--delay': '80ms' }}><article><strong>3곳</strong><b>단톡방과 커뮤니티</b><p>같은 모집 글을 여러 곳에 반복해서 올립니다.</p></article><article><strong>50건</strong><b>채워야 할 목표 응답</b><p>설문을 완성한 뒤에도 모집은 계속됩니다.</p></article><article><strong>4단계</strong><b>반복되는 모집 과정</b><p>제작, 공유, 독촉, 결과 정리를 오갑니다.</p></article></div></section>
    <section className="uf-feature uf-feature--formmate" id="formmate"><div className="uf-feature__copy" data-motion-reveal><span className="uf-kicker">FORMMATE</span><h2>FormMate와 대화하며<br />설문을 만들어보세요</h2><p>원하는 주제와 목적을 말하면 설문 제목, 설명, 질문 유형과 선택지까지 초안을 제안합니다. 생성된 내용은 직접 확인하고 바로 수정할 수 있습니다.</p><Link className="uf-text-link" to="/formmate">FormMate 시작하기 <span>→</span></Link></div><ProductFrame label="UniForm 설문 만들기" className="uf-feature__product" data-motion-reveal style={{ '--delay': '80ms' }}><FormMatePreview /></ProductFrame></section>
    <section className="uf-feature uf-feature--leaderboard" id="leaderboard"><ProductFrame label="UniForm 리더보드" className="uf-feature__product" data-motion-reveal><LeaderboardPreview /></ProductFrame><div className="uf-feature__copy" data-motion-reveal style={{ '--delay': '80ms' }}><span className="uf-kicker">LEADERBOARD &amp; REWARD</span><h2>응답에<br />재미를 더하다</h2><p>설문에 참여한 횟수가 매주 리더보드에 반영됩니다. 상위 3명에게는 문화상품권 경품을 제공해 참여할 이유를 분명하게 만듭니다.</p><div className="uf-reward-summary"><b>매주 TOP 3</b><span>5만원 · 3만원 · 1만원 문화상품권</span></div><Link className="uf-text-link" to="/leaderboard">이번 주 순위 확인하기 <span>→</span></Link></div></section>
    ...
    <section className="uf-final" data-motion-reveal><div><h2>첫 설문을<br />지금 시작해보세요</h2><p>FormMate로 만들고, UniForm에서 참여자를 만나보세요.</p><Link className="uf-button uf-button--primary" to="/signup">무료로 시작하기</Link></div></section>
    <footer className="uf-footer"><BrandMark /><p>대학생을 위한 설문 제작과 참여 플랫폼</p><nav><a href="#formmate">FormMate</a><a href="#leaderboard">리더보드</a><a href="#team">팀 관리</a><Link to="/login">로그인</Link></nav><small>© 2026 UNIFORM</small></footer>
  </main>
}
